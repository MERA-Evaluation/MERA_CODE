...
export HF_TOKEN="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" 
...
# export MERA_MODEL_STRING="pretrained=Qwen/Qwen2.5-Coder-0.5B-Instruct,dtype=bfloat16" 
# export MERA_COMMON_SETUP="--trust_remote_code --limit 10"
